...
var button = [
{"urlButton": {"displayText": "MyOwner🔥","url": `https://wa.me/6283848574563`}},
{"quickReplyButton": {"displayText": "Sewabot","id": 'sewabot'}},
{"quickReplyButton": {"displayText": "Donasi","id": 'donasi'}},
{"quickReplyButton": {"displayText": "Status Bot YTTA BOT","id": 'ping'}}
		]
...
hydratedFooterText: 'Created By Farel',
hydratedButtons: [{
urlButton: {
...
break
case 'credits':
const sokl = "6283848574563@s.whatsapp.net"
teksits = `「 *Thanks To* 」
♕ Akira @${sokl.split("@")[0]}`
...
const botzkir = "6283848574563@s.whatsapp.net"
...
kasjn Disini Ingin Membantu Kalian Membuat Sticker Download Video/Lagu Youtube, Tiktok Dll.`
let buttons = [
...
kirbotz.send5Loc(m.chat, `On Kak Silahkan Pencet Button Di Bawah\nJika Button Tidak Kelihatan Ketik ${prefix}menu`, `Created By Farel`, global.thumb, btn)
}
break
case 'userkirbotz':{
...
kirbotz.send5ButImg(i, junn, `Created By Farel`, buffer, butoon)
} else if (/video/.test(mime)) {
let junn = `*_BROADCAST VIDIO_*${text ? '\n\n' + text : ''}`
kirbotz.send5Vid(i, junn, `Created By Farel`, buffer, butoon)
...
"businessOwnerJid": "6283848574563@s.whatsapp.net",
}
...
imageMessage: message.imageMessage,
hydratedContentText: pll,
hydratedFooterText: 'Created By Far',
hydratedButtons: [{
urlButton: {
displayText: 'MyGithub',
url: 'https://github.com/'
...
const djej = "6283848574563@s.whatsapp.net"
